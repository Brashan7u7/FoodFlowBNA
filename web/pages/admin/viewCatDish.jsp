        ...
        <div style="margin-left: 100px; padding: 20px; min-width: 100vh;">
            ...
            <div class="fieldset">
                <div class="row mb-3">
                    ...
                    <div class="col-2">
                        <a href="createCategory"><button type="button" class="btn btnAdd w-100">Agregar</button></a>
                    </div>
                </div>
                <div class="row">
                    <table class="table">
                        ...
                        <tbody class="table-group-divider">
                            ...
                            %>
                            <tr onclick="window.location.href = '/foodflow/editCategory?id=<%= categoria.getId()%>'">
