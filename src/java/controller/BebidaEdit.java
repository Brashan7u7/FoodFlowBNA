...
@WebServlet("/editDrink")
public class BebidaEdit extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( Connection conn = new ConnectionBD().getConnectionBD()) {
            ...
            request.getRequestDispatcher("/pages/admin/editDrink.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "UPDATE bebidas SET nombre = ?, imagen = ?, descripcion = ?, precio_unitario = ?, categoria_id = ?, disponibilidad = ? WHERE id = ?";
        try {
