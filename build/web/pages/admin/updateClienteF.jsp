...
<html>
    ...
    <body>
        ...
        <div style="margin-left: 100px; padding: 20px; min-width: 100vh;">
            ...
            <!-- Buscar cliente -->
            <form method="GET" action="<%= request.getContextPath() %>/clienteFupdate">
                <label for="id">Buscar Cliente por ID:</label>
                <input type="text" id="id" name="id" placeholder="Ingrese ID del cliente" required>
            ...
            <div class="mt-5">
                <form action="<%= request.getContextPath()%>/clienteFupdate" method="POST">
                    ...
                    <!-- Campo para el número de compras -->
                    <div class="d-flex justify-content-start align-items-center">
                        <div class="col-4 text-end mt-3">
                            <p class="font">Número de compras:</p>
                        </div>
                        <div class="col-4 ms-2">
                            <input type="number" id="compras" name="compras" value="<%= cliente.getCompras() %>" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <button type="submit" class="btn btnAdd mx-2">Actualizar</button>
